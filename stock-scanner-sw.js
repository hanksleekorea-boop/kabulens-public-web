...
self.addEventListener('fetch',event=>{
  ...
  // OAuth and account API requests must reach the Worker directly. A service
  // worker navigation fallback would otherwise swallow the 302 to Google.
