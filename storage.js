(function(root,factory){var api=factory();if(typeof module==='object'&&module.exports)module.exports=api;else root.KabuStorage=api;})(typeof self!=='undefined'?self:this,function(){
  'use strict';
  var KEY='kabulens.user.v5', LEGACY=['kabulens.user.v4','kabulens.user.v3','kabulens.user.v2','kabulens.user.v1'];
  ...
  function fresh(){return {schemaVersion:5,watchlist:[],positions:[],settings:{largeText:false,reduceMotion:false,highContrast:false,compactView:false},unknown:{}};}
  function migrate(raw){
    ...
    Object.keys(source).forEach(function(k){if(['schemaVersion','watchlist','favorites','positions','settings','unknown'].indexOf(k)<0)next.unknown[k]=source[k];});
