...
SURFACES = {
    ...
    "commercial-free-readiness.json": ("application/json", b'"releaseVersion": "7.3"', 100_000),
    ...
    "stock-scanner-sw.js": ("javascript", b"stock-scanner-shell-v7-3-ad-stage3", 100_000),
